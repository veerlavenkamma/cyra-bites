...
// Global Exception boundary as described in the Firebase Integration skill
...
// Test connectivity as requested in the Firebase Integration skill
export async function validateFirestoreConnection() {
  try {
    await getDocFromServer(doc(db, 'test-sandbox', 'connection-probe'));
